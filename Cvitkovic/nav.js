...
<nav id="navbar">
  <div class="nav-inner">
    <a href="index.html" class="nav-logo" aria-label="Fizio Cvitković - Početna">
    ...
    <ul class="nav-links">
      <li><a href="index.html" class="${isActive('index.html')}">Početna</a></li>
  ...
  <div class="nav-mobile" id="navMobile">
    <a href="index.html" class="${isActive('index.html')}">Početna</a>
    ...
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <div class="footer-contact-item">
          ...
          <span>Pon–Pet: 8:30–20:00<br>Sub–Ned: Zatvoreno</span>
        </div>
      </div>
    </div>
